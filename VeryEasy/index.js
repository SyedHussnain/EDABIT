...
console.log(
	"Return the sum of Two Numbers = " + sum(15, 32)
);
...
console.log(
	"Minutes in to Seconds = " + minToSec(60)
);
...
console.log(
	"Area of triAngle = " + triArea(10, 20)
);
...
console.log(
	"Circuit Power = " + circuitPower(230, 10)
);
...
console.log(
	"Hours in Seconds = " + hoursIntoSeconds(2)
);
...
console.log(
	"Number is Less Or Equal to Zero = " +
...
console.log(
	"Name with Edabit = " + nameString("Hussnain")
);
...
console.log(
	"Sum of two Numbers Less than Zero = " +
		lessThan100(50, 49)
);
...
console.log(
	"Total Legs of Animals = " + animals(2, 3, 5)
);
...
console.log(
	"Time in Seconds = " + hrMinToSec(1, 20)
);
...
console.log(
	"Number is equal to seven = " + equalToSeven(7)
);
...
console.log(
	"Data Type of Both Parameters are equal = " +
		checkEquality("Hellow", "0")
);
...
console.log(
	"Frames Per Second = " + frames(10, 25)
);
...
console.log(
	"String Calculation = " + calculator("23+4")
);
...
console.log(
	"This Number is Multiple of 100 = " +
		divisibleByHundred(50000000)
);
...
console.log(
	typeof stringInt("6") + " = " + stringInt("6")
);
...
console.log(
	addOneInAllElements([1, 2, 3, 4, 5, 6, 7, 8])
);
...
console.log(
	"Drink Served = " + shouldServeDrinks(18, true)
);
...
console.log(
	"Future People = " + futurePeople(3248, 6)
);
...
console.log(
	"TypeOf Variable ab = " + typeof ab + " = " + ab
);

// use of toString
let abc = 50;
console.log(
	"Type of the Variable abc = " +
		typeof abc +
		" = " +
		abc
);
...
let mm = parseInt1(50);
console.log(
	"TypeOf the Argument Passed in Num = " +
		typeof mm +
		" = " +
		mm
);
...
let nn = toString1("50");
console.log(
	"TypeOf the Argument Passed in String = " +
		typeof nn +
		" = " +
		nn
);
...
console.log(
	" Possible Numbers of Arrangement of Swithes = " +
		posCom(10)
);
